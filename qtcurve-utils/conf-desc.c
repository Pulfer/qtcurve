...
{
    QTC_DECL_STR_MAP(conf_type_map, true, {"Str", QTC_CONF_STR},
    ...
    return qtcStrMapSearch(&conf_type_map, str);
}
...
_qtcConfDescLoadConstrain(QtcConfValueDesc *vdesc, QtcIniGroup *ini_grp)
{
    ...
    case QTC_CONF_ENUM: {
        ...
        QtcConfEnumDesc *enum_descs = qtcNewN(QtcConfEnumDesc, enum_alloc);
        for (;;i++) {
